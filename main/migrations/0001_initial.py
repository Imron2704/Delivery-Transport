# Generated by Django 3.2.13 on 2022-12-04 18:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=75)),
                ('image', models.ImageField(null=True, upload_to='images/truck_images')),
                ('description', models.TextField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('car', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='truck_images', to='main.truck')),
            ],
        ),
        migrations.CreateModel(
            name='Blog',
